#' Create tidy dataframes for MCH HIV testing services
#'
#' `parse_sisma_ats_smi` produces a tidy dataframe from an object passed in by
...
#'
#' @return `parse_sisma_ats_smi` returns a tidy object with 16 columns of
